...
jade.templates = jade.templates || {};
jade.templates['category-field-edit'] = (function(){
  return function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
...
buf.push('/></div><div class="control-group"><label class="control-label">Цена</label><input type="text" name="price" placeholder="Цена" value=""/></div><div class="control-group"><label class="control-label">Описание</label><textarea name="description" placeholder="Описание" rows="3"></textarea></div></div><div class="span6"><div class="control-group"><div class="control-group span3"><label class="control-label">Фото</label><div class="upload-photo"></div><br/><div class="uploaded-photo-placeholder"></div></div></div><div class="control-group"><div class="span6"><label class="control-label">Опубликовать</label><div class="b-published b-toggle-button"><input type="checkbox" name="published"/></div></div></div><div class="control-group"><div class="span6"><label class="control-label">Наличие</label><div class="b-published b-toggle-button"><input type="checkbox" checked="checked" name="onStock"/></div></div></div></div></div><div class="row"><div class="span12"><legend>Дополнительно</legend><div class="control-group"><label class="control-label">Inline поле</label><input type="text" name="inline" placeholder="Inline" value=""/></div><div class="control-group"><label class="control-label">Miltiline поле</label><textarea name="multiline" placeholder="Multiline" rows="3"></textarea></div></div></div><div class="row"><div class="span12"><legend>Фотографии</legend></div></div><div class="row"><div class="span12"><legend>Действия</legend><div class="control-group"><button type="submit" name="save" value="on" class="b-profile__save btn btn-primary">Сохранить</button>');
if ( locals._id)
{
buf.push('&nbsp;<button type="button" name="delete" value="on" class="b-category__delete btn">Удалить</button>');
}
...
jade.templates = jade.templates || {};
jade.templates['users-profile'] = (function(){
  return function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
...
with (locals || {}) {
var interp;
buf.push('<div class="container b-users"><div class="row"><h1>Пользователи</h1></div><div class="row b-users__list"><table class="table table-bordered table-striped b-users-table"><thead><tr><th>id</th><th>email</th><th>роли</th></tr></thead><tbody class="b-users-table__body"></tbody></table></div><div class="row b-users__pagination"></div></div>');
}
return buf.join("");
};
})();
...
(function() {
  ...
  Witness.models.CategoryField = (function(_super) {

    __extends(CategoryField, _super);

    function CategoryField() {
      return CategoryField.__super__.constructor.apply(this, arguments);
    }

    CategoryField.prototype.idAttribute = "_id";

    CategoryField.prototype.initialize = function() {
      var _this = this;
...
(function() {
  ...
  Witness.models.CategoryFields = (function(_super) {

    __extends(CategoryFields, _super);

    function CategoryFields() {
      return CategoryFields.__super__.constructor.apply(this, arguments);
    }

    CategoryFields.prototype.initialize = function(users) {};

    CategoryFields.prototype.model = Witness.models.CategoryField;
...
(function() {
  ...
  Witness.models.UserProfile = (function(_super) {
...
(function() {
  ...
  Witness.models.UserEntry = (function(_super) {

    __extends(UserEntry, _super);

    function UserEntry() {
      return UserEntry.__super__.constructor.apply(this, arguments);
    }

    UserEntry.prototype.initialize = function() {
      this.view = new Witness.views.UserEntry();
...
(function() {
  ...
  Witness.models.Users = (function(_super) {
    ...
    Users.prototype.model = Witness.models.UserEntry;
...
(function() {
  ...
  Witness.views.CategoryEdit = (function(_super) {

    __extends(CategoryEdit, _super);

    function CategoryEdit() {
      return CategoryEdit.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  Witness.views.CategoryFieldEdit = (function(_super) {

    __extends(CategoryFieldEdit, _super);

    function CategoryFieldEdit() {
      return CategoryFieldEdit.__super__.constructor.apply(this, arguments);
    }

    CategoryFieldEdit.prototype.initialize = function(options) {
      return Backbone.Validation.bind(this);
    };

    CategoryFieldEdit.prototype.destroy = function() {
      return this.remove();
    };
    ...
    CategoryFieldEdit.prototype.validate = function() {
      this.model.set({
        "machineName": this.$el.find("[name=\"machine-name\"]").val(),
        "name": this.$el.find("[name=\"name\"]").val(),
        "multiline": this.$el.find(".b-category-field__multiline").data("multiline") === true
      }, {
        silent: true
      });
      this.model.validate();
      return this.$el.find(".b-category-field__valid i").toggleClass("icon-ok", this.model.isValid()).toggleClass("icon-remove", !this.model.isValid());
    };

    CategoryFieldEdit.prototype.className = "input-prepend input-append b-category-field";
  ...
  Witness.views.ProductEdit = (function(_super) {
    ...
    ProductEdit.prototype.render = function() {
      var uploader,
        _this = this;
      Witness.View.prototype.render.apply(this, arguments);
      this.$(".b-toggle-button").toggleButtons();
      uploader = new qq.FineUploader({
        element: this.$(".upload-photo").get(0),
        multiple: false,
        validation: {
...
(function() {
  ...
  Witness.views.UserEntry = (function(_super) {
    ...
    UserEntry.prototype.tagName = "tr";

    UserEntry.prototype.template = "user";
